...
\begin{document}
    \bigpart{Expressions littérales}
        \subpart{Définition}
            \definition{expression_litterale_variables}
        ...
        \subpart{Conventions d'écriture}
            ...
            \vskip5pt\par\noindent{\bfseries Exemple :}\vskip5pt\par\noindent
                ...
                %     \end{multicols}
                % \end{enumerate}
                \vskip5pt\par\noindent{\bfseries Remarque :}\vskip5pt\par\noindent
                ...
                % \end{enumerate}
    \newpage
    \bigpart{Évaluer d'une expression littérale}
        \definition{evaluer_une_expression_litterale}
        \vskip5pt\par\noindent{\bfseries Exemple :}\vskip5pt\par\noindent
            ...
            $$\begin{array}{cccc}
                ...
                =&&-20&
            \end{array}$$
    \bigpart{Test d'égalité}
        \definition{egalite_membres}
        \definition{tester_une_egalite}
        \vskip5pt\par\noindent{\bfseries Exemple :}\vskip5pt\par\noindent
            \begin{enumerate}[label=\arabic*),font=\bfseries]
        ...
        \vskip5pt\par\noindent{\bfseries Exemple :}\vskip5pt\par\noindent
            ...
            \end{enumerate}
        \newpage
        \bigpart{Réduction d'une expression littérale}
