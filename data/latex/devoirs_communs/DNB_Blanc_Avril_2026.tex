% compilation LuaTeX Version 1.24.0 (MiKTeX 26.2 Portable)
\documentclass{article}
\usepackage[hmargin=20pt]{geometry}
% ====================
...
\begin{enumerate}
    ...
    \item \begin{minipage}[t]{.5\linewidth}
        ...
        \begin{enumerate}
            \item Donner un antécédent de 2 par la fonction $f$~?
            \answerspace{1em}
            \item Quel est l'image de -1 par la fonction $f$~?
            \answerspace{1em}
            \item Quel est l'image de 0 par la fonction $f$~?
            \answerspace{1em}
            \item Donner un antécédent de 0 par la fonction $f$~?
            \answerspace{1em}
        \end{enumerate}
...
% ==========
    ...
    \begin{enumerate}
        ...
        d'axe \mathspoint{(AF)}~?
        \item Quelle est l'image du losange \circled7 par la rotation
    ...
    \begin{enumerate}
        ...
        \item Recopier et compléter les lignes 3, 4 et 5 du script ci-contre afin que
