...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        save_under_action.triggered.connect(
            self.save_on_progression
        )
        ...
        self.add_level_button.setToolTip(
            "Ajouter un niveau (Ctrl+L)"
        )

        self.add_chapter_button.setToolTip(
            "Ajouter un chapitre (Ctrl+K)"
        )
